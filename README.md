...
| 2 | Now fill in: <br> Password = ```abcd1234``` <br> The same in the next field for password confirmation, check the checkbox and click ***Register*** | Display of error message because the SSN already exists in the database: <br> 🟥 Username, Email or SSN already exists! |
